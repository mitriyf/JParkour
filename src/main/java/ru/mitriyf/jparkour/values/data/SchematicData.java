...
public class SchematicData {
    ...
    private int health, foodLevel, damageBomb, exitTime, timer, yaw, north, x, y, z, maxLefts, maxRights, forward;
    ...
    private void setupSettings(YamlConfiguration cfg) {
        ...
        north = locationSection.getInt("north");
    ...
    private void generateLocs(ConfigurationSection locs) {
        ...
        FileConfiguration slotsConfig = values.getItemSlots();
